...
setup (name = 'plane_pymavlink',
       version = __version__,
       description = 'Python MAVLink code',
       long_description = long_description,
       long_description_content_type = "text/markdown",
       url = 'https://github.com/StableKite/plane_pymavlink/',
       ...
       license='LGPLv3',
       package_dir = { 'plane_pymavlink' : '.' },
       package_data = { 'plane_pymavlink.dialects.v10' : ['*.xml'],
                        'plane_pymavlink.dialects.v20' : ['*.xml'],
                        'plane_pymavlink.generator'    : [ '*.xsd',
                                                     'java/lib/*.*',
                                                     'java/lib/Messages/*.*',
                                                     'C/include_v1.0/*.h',
                                                     'C/include_v1.0/*.hpp',
                                                     ...
                                                     'CS/*.*',
                                                     'swift/*.swift',],
                        'plane_pymavlink'              : ['message_definitions/v*/*.xml']
                        },
       packages = ['plane_pymavlink',
                   'plane_pymavlink.generator',
                   'plane_pymavlink.dialects',
